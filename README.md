...
<ul>
  <li>The dataset consists of 10,868 bytes file in a hexadecimal representation and 10,868 asm files.</li>
  <li>The files in the dataset represent a mix of 9 different families of malware.</li>
  <li>A file may belong to any of the following 9 classes of malware: Ramnit, Lollipop, Kelihos_ver3, Vundo, Simda, Tracur, Kelihos_ver1, Obfuscator.ACY, Gatak.
</li>
</ul>
